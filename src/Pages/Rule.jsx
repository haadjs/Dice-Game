  ...
  return (
    <>
      <div className="flex justify-center items-center py-7 p-2">
        <div className="max-w-xl mx-auto mt-10 p-6 bg-black shadow-xl rounded-xl border border-rose-200">
          ...
          <ul className="list-disc list-inside text-rose-800 text-lg space-y-2">
            ...
            <li>
              If the selected number matches the dice number, you will earn the
              same points as shown on the dice.
            </li>
            <li>
              If your guess is wrong, 2 points will be deducted from your score.
            </li>
            <h1 className="text-center font-extrabold">Rule:-</h1>
            <li>
